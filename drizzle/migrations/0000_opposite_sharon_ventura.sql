CREATE TYPE "public"."plan_type" AS ENUM('free', 'subscribed');--> statement-breakpoint
CREATE TYPE "public"."sub_status" AS ENUM('active', 'past_due', 'unpaid', 'cancelled', 'expired');--> statement-breakpoint
